...
namespace ScaffoldingwithController.Controllers
{
    public class TestModelsController : Controller
    {
        private readonly ScaffoldingwithControllerContext _context;
      
        public TestModelsController(ScaffoldingwithControllerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Mobile,Datetime,Email")] TestModel testModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Mobile,Datetime,Email")] TestModel testModel)
        {
            if (id != testModel.Id)
            {
                return NotFound();
